...
export default function BlogLayout({
  ...
  return (
    <div className="blog-tufte-light flex min-h-screen flex-col">
      ...
      {/* Blog content */}
      <div className="blog-post relative mx-auto w-full max-w-[1400px] flex-1 px-6 pt-12">
        <ReferenceProvider key={pathname}>
          {isPostPage ? (
            <>
              ...
              <div className="grid grid-cols-1 gap-12 lg:grid-cols-[224px_1fr] xl:grid-cols-[224px_1fr_300px]">
