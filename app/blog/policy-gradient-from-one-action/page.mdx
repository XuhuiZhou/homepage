...
For a trajectory, a possible world contains the entire sampled rollout: its states, actions, and
rewards. The past reward is **not** one global constant across these worlds. One rollout may reach the
...
The final panel below also previews the **policy score**. In this binary example, read it as the push
