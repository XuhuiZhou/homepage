...
<div className="not-prose mb-8 rounded-lg border border-purple-200 bg-purple-50 p-4">
  <div className="text-sm font-semibold text-purple-900">TL;DR</div>
...
<Citation
  ...
  title={'The overlooked "bad" word list'}
  year="2024"
  url="https://xuhuiz.com/blog/the-overlooked-bad-word-list"
  bibtexKey="zhou2024badwordlist"
/>
