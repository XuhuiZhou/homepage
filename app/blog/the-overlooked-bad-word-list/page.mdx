export const metadata = {
  title: 'The overlooked "bad" word list',
...
# The overlooked "bad" word list

<div className="not-prose mb-8 border-b border-zinc-200 pb-6 dark:border-zinc-800">
  <div className="text-sm text-zinc-500 dark:text-zinc-400">
    By Xuhui Zhou · December 15, 2024
  </div>
</div>

<img src="https://www.voicesofyouth.org/sites/voy/files/images/2021-06/tempimageckmi1f.png" alt="Negative words can be harmful" className="mb-8 w-full rounded-lg" />

<div className="not-prose mb-8 rounded-lg border border-purple-200 bg-purple-50 p-4 dark:border-purple-900/30 dark:bg-purple-900/10">
  <div className="text-sm font-semibold text-purple-900 dark:text-purple-200">TL;DR</div>
  <div className="mt-2 text-sm text-purple-800 dark:text-purple-300">
    Stop using the <a href="https://github.com/LDNOOBW/List-of-Dirty-Naughty-Obscene-and-Otherwise-Bad-Words/tree/master" className="underline" target="_blank" rel="noopener noreferrer">List-of-Dirty-Naughty-Obscene-and-Otherwise-Bad-Words</a>, use <a href="https://github.com/XuhuiZhou/toxtrig/tree/master" className="underline" target="_blank" rel="noopener noreferrer">ToxicTrig</a> instead.
  </div>
</div>
